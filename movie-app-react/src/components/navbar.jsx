                    ...
                    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                        <div className="relative flex h-16 items-center justify-between">
                            <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                                {/* Mobile menu button*/}
                                <DisclosureButton className="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-blue-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                                        ...
                                        {navigation.map((item) =>
                                            <NavLink
                                                ...
                                                className={({ isActive }) => classNames(
                                                    isActive ? 'bg-blue-gray-900 text-white' : 'text-gray-300 hover:bg-blue-gray-700 hover:text-white',
